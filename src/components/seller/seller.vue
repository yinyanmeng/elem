    	...
    	<div class="bulletin">
    		...
    		<ul v-if="seller.supports" class="supports">
	    			<li class="support-item" v-for="(support,index) in seller.supports">
	    				...
	    				<p class="text">{{support.description}}</p>
	    			</li>
	    		</ul> 
    	</div>
    	<split></split>
...
.seller .bulletin .content-wrapper{
	padding:0 12px 16px 12px; position: relative;
}
...
.supports .support-item .decrease{background-image: url('decrease_4@2x.png');}
.supports .support-item .discount{background-image: url('discount_4@2x.png');}
.supports .support-item .guarantee{background-image: url('guarantee_4@2x.png');}
.supports .support-item .invoice{background-image: url('invoice_4@2x.png');}
.supports .support-item .special{background-image: url('special_4@2x.png');}
@media 
(-webkit-min-device-pixel-ratio: 3),(min-device-pixel-ratio:3) { 
.supports .support-item .decrease{background-image: url('decrease_4@3x.png');}
.supports .support-item .discount{background-image: url('discount_4@3x.png');}
.supports .support-item .guarantee{background-image: url('guarantee_4@3x.png');}
.supports .support-item .invoice{background-image: url('invoice_4@3x.png');}
.supports .support-item .special{background-image: url('special_4@3x.png');}
}
